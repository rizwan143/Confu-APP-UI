...
enum StaticLabels: String {
    ...
    case pnNoMeetingFound = "No recent meeting found yet!"
    case pnInstructionText = "Press Button To Start/Schedule  Conference"
    ...
    case cpnameVisibilityText = "This name will be visible to your confu contacts."
    ...
    case emptyNearbyTableViewContent = "No nearby meetings found"
