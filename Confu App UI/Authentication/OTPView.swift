...
//    
//    let btnContinue = CFPrimaryButton(title: "Continue", backgroundColor: .black, titleColor: .white)
//    
...
//            lblLargeTitle.topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor, constant: 8),
